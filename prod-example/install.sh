...
# .env
# CLAUDE_CWD=/ gives the chat full-server access (file browser, terminal).
# That matches the single-user trust model — ALLOWED_EMAIL is the gate, not
# a filesystem sandbox. Narrow it (e.g. /root) if you want tighter scope.
