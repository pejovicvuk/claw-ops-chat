...
function resolveBundledClaudeBinary() {
    ...
    const roots = [
        ...
        (0, path_1.join)(process.cwd(), "node_modules", "@anthropic-ai", "claude-agent-sdk", "node_modules", "@anthropic-ai"),
    ];
...
function detectClaude() {
    ...
    try {
        const direct = (0, path_1.join)(process.cwd(), "node_modules", "@anthropic-ai", "claude-agent-sdk", "sdk.mjs");
